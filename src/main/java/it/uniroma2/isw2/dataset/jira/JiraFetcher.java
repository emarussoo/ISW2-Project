...
public class JiraFetcher {
    ...
    /**
     * Recupera tutti i ticket di tipo Bug, status Closed/Resolved, resolution Fixed
     * e popola affectedVersions in base al dizionario di release fornite.
     */
    public static List<Ticket> getBugs(String projName, List<Release> projectReleases) throws IOException, JSONException {
        ...
        // DateTime formatter per Jira format (es. 2021-09-15T15:23:00.000+0000)
        ...
        do {
            ...
            for (int k = 0; k < issues.length(); k++) {
                ...
                // Leggiamo affectedVersions (AV) da Jira
                if (fields.has("versions")) {
                    ...
                    for (int z = 0; z < avArray.length(); z++) {
                        ...
                        if (avObj.has("id")) {
                            ...
                            // Cerchiamo la release corrispondente
